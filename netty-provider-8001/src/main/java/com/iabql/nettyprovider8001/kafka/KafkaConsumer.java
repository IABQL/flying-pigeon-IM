package com.iabql.nettyprovider8001.kafka;

import com.alibaba.fastjson.JSONObject;
import com.iabql.nettyprovider8001.enums.MsgActionEnum;
import com.iabql.nettyprovider8001.netty.ChatHandler;
import com.iabql.nettyprovider8001.netty.ChatMsgNetty;
import com.iabql.nettyprovider8001.netty.DataContent;
import com.iabql.nettyprovider8001.netty.UserChanelRel;
import com.iabql.nettyprovider8001.utils.JsonUtils;
...
public class KafkaConsumer {
    ...
    @KafkaListener(topics = "localhost_8001")
    ...
    private void dealMessage(DataContent dataContent) {
        ...
        if(action == MsgActionEnum.CHAT.type) {
            ...
            // 不用再保存消息到数据库，因为在转发之前已经将消息存入mysql
